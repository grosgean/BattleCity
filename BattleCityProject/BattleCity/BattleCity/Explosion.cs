...
namespace BattleCity
{
    ...
    public class Explosion
    {
        ...
        private void Initialize(Texture2D spriteStrip)
        {
            ...
            frameWidth = GameConstants.TILE_WIDTH;
            frameHeight = GameConstants.TILE_WIDTH;

            // set initial draw and source rectangles
            drawRectangle = new Rectangle(0, 0, frameWidth, frameHeight);
            sourceRectangle = new Rectangle(0, GameConstants.TILE_WIDTH * 2, frameWidth, frameHeight);
        }
        ...
        private void SetSourceRectangleLocation(int frameNumber)
        {
            ...
            sourceRectangle.Y = GameConstants.TILE_WIDTH * 2 + (frameNumber / GameConstants.EXPLOSION_FRAMES_PER_ROW) * frameHeight;
        }
